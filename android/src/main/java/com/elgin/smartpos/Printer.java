...
public class Printer {
    ...
    public void setDefaultImage(){
        int id;
        id = SmartPOSPlugin.mActivity.getApplicationContext().getResources().getIdentifier("elgin","drawable", SmartPOSPlugin.mActivity.getApplicationContext().getPackageName());
        selectedImageBitmap = BitmapFactory.decodeResource(SmartPOSPlugin.mActivity.getApplicationContext().getResources(), id);
    }
